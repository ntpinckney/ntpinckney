...
Currently in final testing—just smoothing out the UI and running a few more checks before release.  Built with Java, XML, and Figma.
**STATUS: Almost done with implementation. Just running a few more tests and smoothing out the UI.** 
- ⛅ WeatherApp (Spring Boot) – A web-based weather tracking application that fetches and displays five-day forecasts based on user input. Built with Java, Spring Boot, HTML, CSS (Bootstrap), and JavaScript with plans for UI and feature enhancements.
